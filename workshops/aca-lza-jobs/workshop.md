...
2. Install pre-reqs azure CLI, Docker client
    ...
    Unfortunately the jump host doesn't have the required tools installed. So, you would have to install them.
